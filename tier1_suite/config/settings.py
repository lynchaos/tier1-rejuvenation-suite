...
class TierConfig(BaseSettings):
    ...
    def validate_config(self) -> List[str]:
        ...
        if not self.global_config.output_directory.parent.exists():
            warnings.append(f"Output directory parent does not exist: {self.global_config.output_directory.parent}")
...
def save_config_template(output_path: Union[str, Path] = "config_template.yaml") -> None:
    """
...
def create_provenance_tracker(pipeline_name: str, config: Optional[GlobalConfig] = None) -> ProvenanceTracker:
    """

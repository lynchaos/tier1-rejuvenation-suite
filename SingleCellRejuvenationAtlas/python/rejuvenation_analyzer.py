...
class RejuvenationAnalyzer:
    ...
    def cellular_reprogramming_predictor(self):
        ...
        self.adata.obs['reprogramming_potential'] = reprogramming_scores[:, 2]  # rejuvenated class
    ...
    def senescence_marker_analysis(self):
        ...
        if available_markers:
            sc.pl.dotplot(self.adata, available_markers, groupby='leiden', save='_senescence_markers.pdf')
            
            # Calculate senescence score
            sc.tl.score_genes(self.adata, available_markers, score_name='senescence_score')
    ...
    def stem_cell_pluripotency_scoring(self):
        ...
        available_markers = [m for m in pluripotency_markers if m in self.adata.var_names]
        
        if available_markers:
            sc.tl.score_genes(self.adata, available_markers, score_name='pluripotency_score')
    ...
    def generate_plots(self):
        ...
        # UMAP plot
        sc.pl.umap(self.adata, color=['leiden', 'reprogramming_potential'], save='_rejuvenation_umap.pdf')
